...
namespace EBS.Controllers
{
    ...
    public class MeterController : Controller
    {
        ...
        private void InsertMeter(MeterWrapper model)
        {
            ...
            {
                connection.Open();
                string Insertquery = "INSERT INTO Meters (cID, lockNumber, Type, Status) VALUES (@cID, @lockNumber, @Type, @Status)";
        ...
        private void UpdateMeterMethod(MeterWrapper model)
        {
            ...
            {
                connection.Open();
                string query = "UPDATE Meters SET cID = @cID lockNumber = @lockNumber, Type = @Type, Status = @Status WHERE MeterID = @MeterID";
